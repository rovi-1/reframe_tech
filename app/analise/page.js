...
export default function Analise() {
  return (
    <main className={styles.main}>
      <div id="analiseBG" className="pb-20 ">
        <Navbar />
        <div className="ml-10 md:ml-64 mt-10 md:mt-48 mr-10 md:mr-64 justify-center flex flex-col mb-auto md:mb-72 ">
          ...
          >
            Utilize todo o insight dos dados, trasnformando sua organização em
            um ecossistema data-driven, através da análise, coleta e mensuração
            de dados.
          </h3>
        </div>
      </div>
      <div className="md:mt-96 md:mr-56 md:mb-96 md:ml-56 mt-10 ml-14 mr-14 flex flex-row justify-center ">
        ...
        >
          Entendemos que os dados, são uma fonte valiosa de insights para a
          tomada de decisão em uma empresa. Por isso, fornecemos tudo que sua
          organização precisa para utilizar o poder dos dados no escalamento de
          seu negócio.
        </span>
      </div>
      <div className="flex justify-center items-center mt-20 bg-purple-900 p-20 md:h-screen">
        <div className="flex flex-col md:flex-row gap-10 ml-64 mr-64">
          <div className="flex flex-col">
            ...
            >
              <br />
              Criamos uma ferramenta de a análise e visualização de dados da sua
              empresa do zero, de forma a possibilitar ao seu time, o
              fornecimento de insights valiosos.
            </div>
          </div>
          <div className="flex flex-col">
            <div
            ...
            >
              <br />
              Fornecemos análises e relatórios completos de conceitos pré-
              estabelecidos, de modo a gerarmos relatórios e insights sobre o
              posicionamento de mercado ou interno de seu negócio.
            </div>
          </div>
          <div className="flex flex-col">
            <div
            ...
            >
              <br />
              Criamos modelos de aprendizado de máquina de análise preditiva ou
              descritiva, para auxiliar sua empresa na tomada de decisões e na
