...
export default function Home() {
  return (
    ...
    <main className={styles.main}>
      ...
      <div className='mt-24 ml-10 mr-10 md:ml-32 md:mr-32 h-2/3 mb-40 justify-center flex rounded-lg items-center flex-col md:flex-row'>
        <div id="bg_1" className=' md:mr-12 w-96 md:w-1/2 mt-10 md:h-auto rounded-3xl'></div>
        <div className='mt-10 flex flex-col md:w-1/2'>
        <h3 className={`${orbitronTitle.className} text-left  text-white text-2xl xl:text-xl 2xl:text-4xl `}>Desbloqueamos todo o <span className='text-purple-900'> potencial</span>  da sua empresa, de maneira personalizada</h3>
        <span className={`${orbitronTitle.className} text-left  text-white text-sm xl:text-lg 2xl:text-2xl mt-10 `} >Entendemos que cada negócio é único, com seus  próprios desafios e oportunidades. É por isso que  nossa consultoria organizacional é altamente personalizada e visa entender de perto as dificuldades que sua empresa enfrenta. A partir  daí, desenvolvemos soluções inovadoras e certeiras para ajudá-lo a alcançar seus objetivos e desbloquear seu potencial máximo.</span>
        </div>
      </div>
      </Link>
      ...
      <div className='mt-32 ml-10 mr-10 md:ml-32 md:mr-32 h-2/3 justify-center flex rounded-lg items-center flex-col-reverse md:flex-row mb-80'>
        ...
        <h3 className={`${orbitronTitle.className} text-left text-white text-2xl xl:text-xl 2xl:text-4xl`}>Softwares inteligentes epersonalizados ao seu <span className='text-purple-900'> alcance</span></h3>
        <span className={`${orbitronTitle.className} text-left text-white text-sm xl:text-lg 2xl:text-2xl mt-10`} >Entendemos que cada negócio é único, com seus  próprios desafios e oportunidades. É por isso que  nossa consultoria organizacional é altamente personalizada e visa entender de perto as dificuldades que sua empresa enfrenta. A partir  daí, desenvolvemos soluções inovadoras e certeiras para ajudá-lo a alcançar seus objetivos e desbloquear seu potencial máximo.</span>
        </div>
        <div id="bg_2" className=' md:ml-12 w-3/3 md:w-1/2 h-64 mt-10 md:h-auto rounded-3xl'></div>
      </div>
      </Link>
      <Link href={"analise"}>
  <div className='mt-32 ml-10 mr-10 md:ml-32 md:mr-32 h-2/3 justify-center flex rounded-lg items-center flex-col md:flex-row pb-56 md:flex-grow md:items-center md:justify-center'>
    <div id="bg_3" className=' md:mr-12 w-3/3 md:w-1/2 h-64 mt-10  md:h-auto rounded-3xl'></div>
    <div className='mt-10 flex flex-col md:w-1/2'>
      <h3 className={`${orbitronTitle.className} text-left  text-white text-2xlxl:text-xl 2xl:text-4xl`}>Transformamos dados em <span className='text-purple-900'> ação</span></h3>
      <span className={`${orbitronTitle.className} text-left text-white text-sm xl:text-lg 2xl:text-2xl mt-10`} >Transformamos suas ideias em realidade com nossas soluções personalizadas de  desenvolvimento de  software. Com uma abordagem colaborativa e ágil, estamos prontos para ajudá-lo a atingir seus objetivos e se destacar no mercado.</span>
    </div>
  </div>
</Link>
